...
class Profile extends React.Component {
    ...
    calculateReptiles = () => {
        ...
        } else if (reptilesArray.length > 3 && reptilesArray.length < 5) {
            return <FontAwesomeIcon icon={faDragon} size="3x" color="blue"/>
        } else if (reptilesArray.length > 5) {
    ...
    calculateBirds = () => {
        ...
        } else if (birdsArray.length > 3 && birdsArray.length < 5) {
            return <FontAwesomeIcon icon={faCrow} size="3x" color="blue"/>
        } else if (birdsArray.length > 5) {
    ...
    calculateInsects = () => {
        ...
        } else if (insectsArray.length > 3 && insectsArray.length < 5) {
            return <FontAwesomeIcon icon={faBug} size="3x" color="blue"/>
        } else if (insectsArray.length > 5) {
    ...
    calculateMammals = () => {
        ...
        } else if (mammalsArray.length > 3 && mammalsArray.length < 5) {
            return <FontAwesomeIcon icon={faPaw} size="3x" color="blue"/>
        } else if (mammalsArray.length > 5) {
